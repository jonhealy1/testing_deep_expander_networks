...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, expandsize=2):
        super(BasicBlock, self).__init__()
        self.conv1 = conv3x3_expand(in_planes, planes, expandsize, stride)
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = conv3x3_expand(planes, planes, expandsize)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, expandsize=2):
        ...
        self.conv1 = ExpanderConv2d(in_planes, planes, kernel_size=1, expandSize=(in_planes//expandsize))
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = ExpanderConv2d(planes, planes, kernel_size=3, stride=stride, padding=1, expandSize=(planes//expandsize))
        self.bn2 = nn.BatchNorm2d(planes)
        self.conv3 = ExpanderConv2d(planes, self.expansion*planes, kernel_size=1, expandSize=(planes//expandsize))
...
class ResNet_Deep_Expand(nn.Module):
    def __init__(self, depth, num_classes):
        super(ResNet_Deep_Expand, self).__init__()
        self.in_planes = 16
